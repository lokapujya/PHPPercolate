...
if (isset($_POST['insert'])) {
  ...
  if(isset($_POST['upload_new']) && $_FILES['image']['error'] == 0) {
  	...
  	$upload = new Ps2_ThumbnailUpload('../images/');
    $upload->setThumbDestination('/home/content/l/o/k/lokapujya/html/percolate/phpsols/images/thumbs/');
    ...
    $messages = $upload->getMessages();
  	...
  	// get hte primary key of a previously uploaded image
  	$image_id = $_POST['image_id'];
  }
  //don't insert blog details if the image faild to upload
  if(!isset($imageError)) {
